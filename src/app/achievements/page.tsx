...
const achievements = [
  {
    ...
    image: getCloudinaryUrl('assets/images/achievement-photo-1.jpeg'),
  ...
  },
  {
    ...
    image: getCloudinaryUrl('assets/images/achievement-photo-2.jpeg'),
  ...
  },
  {
    ...
    image: getCloudinaryUrl('assets/images/achievement-photo-3.jpeg'),
    buttonText: 'Read the full article',
  ...
  },
  {
    ...
    image: getCloudinaryUrl('assets/images/achievement-photo-4.jpeg'),
    buttonText: 'Read the full article',
  ...
  },
  {
    ...
    image: getCloudinaryUrl('assets/images/achievement-photo-5.jpg'),
    buttonText: 'Read the full article',
  ...
  },
  {
    ...
    image: getCloudinaryUrl('assets/images/achievement-photo-6.png'),
...
function Achievement() {
  const optimizedLandingPageArchitectureBackground = `url("${getCloudinaryUrl('assets/images/achievemnents-page-background.png')}")`;

  const optimizedBambooBackground = `url("${getCloudinaryUrl('assets/images/achievements-bamboo-background.png')}")`;
        ...
        <ul className="group space-y-5 lg:space-y-12">
          {achievements.map((achievement, index) => (
            <AchievementCard
              ...
              isMobileFill={
                achievement.image ===
                getCloudinaryUrl('assets/images/achievement-photo-4.jpeg')
              } // Add the condition for `achievementMob3`
            />
          ))}
        </ul>
      </section>
