...
export const blogs: Omit<BlogCardDetail, 'imageWidth' | 'imageHeight'>[] = [
  {
    ...
    imageUrl: getCloudinaryUrl('assets/images/blog-images/blog-post-1.jpg'),
    blogURL: '/blogs/01',
  },
  {
    ...
    postedBy: 'admin',
    publishedDate: new Date(),
    imageUrl: getCloudinaryUrl('assets/images/blog-images/blog-post-2.jpg'),
    blogURL: '/blogs/02',
  },
  {
    ...
    postedBy: 'admin',
    publishedDate: new Date(),
    imageUrl: getCloudinaryUrl('assets/images/blog-images/blog-post-3.jpg'),
    blogURL: '/blogs/03',
  },
  {
    ...
    postedBy: 'admin',
    publishedDate: new Date(),
    imageUrl: getCloudinaryUrl('assets/images/blog-images/blog-post-4.jpg'),
    blogURL: '/blogs/04',
  },
] as const;
